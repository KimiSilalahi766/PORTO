...
export function Button({ className, variant='primary', size='md', ...props }: Props) {
  ...
  const variants = { primary: 'bg-primary text-white hover:opacity-90', outline: 'border text-slate-900 border-slate-300 bg-white/70 hover:bg-white/90 dark:text-white dark:border-white/30 dark:bg-black/30 dark:hover:bg-black/45', ghost: 'text-slate-900 hover:bg-black/[.05] dark:text-white dark:hover:bg-white/[.08]' } as const
